...
"""
lat = str(geolocator.latitude)
lon = str(geolocator.longitude)
cuisineType = cuisineTranslate(application.cuisineField) #check against array and convert to numerical value
distance = str(application.distanceField * 1000) #distance will be in km, Zomato api needs in meters
"""
lat = str(43.472285)
lon = str(-80.544858)
cuisineType = str(55)
...
mapUrl = "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + lat + "," + lon + "&key=AIzaSyCN1nbMMdIdWb9o2sfr4MVV1AZVlJ8G_Ug"
...
restQuery = "lat=" + lat + ", lon=" + lon + ", radius =" + distance + ", cuisines=" + cuisineType
